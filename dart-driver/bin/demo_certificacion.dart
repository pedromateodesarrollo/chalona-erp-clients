...
/// Los tipos 33 y 34 conservan su NCFModificado del JSON base.
...
Future<void> main(List<String> args) async {
  ...
  for (var i = 0; i < docs.length; i++) {
    final doc = docs[i];
    final enc = doc['Encabezado'] as Map<String, dynamic>;
    final tipo = (enc['IdDoc'] as Map<String, dynamic>)['TipoeCF'] as String;
    final encf = (enc['IdDoc'] as Map<String, dynamic>)['eNCF'] as String;
    ...
    try {
      ...
      resumen.add('OK   Tipo $tipo  $encf  estado=$estado');
      okCount++;
    } on EcfApiError catch (e) {
      print('  FAIL - ${e.code}');
      resumen.add('FAIL Tipo $tipo  $encf  ${e.code}');
      failCount++;
    }
  }
