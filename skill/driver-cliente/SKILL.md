---
name: driver-cliente
description: Guía interactiva para integrar Chalona ECF con tu ERP. Selecciona, descarga, instala y adapta el cliente en el lenguaje que mejor encaje (Fox, Dart, C#, TypeScript, Python), o ayuda a construir uno nuevo. Úsala cuando el usuario quiera (a) integrar Chalona ECF con su ERP, (b) entender el sistema de drivers hot-reload, o (c) recibir ayuda para diseñar las queries que leen sus tablas (clientes, facturas, compras, suplidores) y para escribir la respuesta de DGII de vuelta. Triggers típicos "quiero integrar chalona con mi ERP", "instalar cliente chalona", "cómo conecto mi sistema", "tengo SQL Server / MySQL / DBF / Mongo".
---
