// Driver TS de prueba — pre-validación de comprobantes e-CF.
// Espejo de DriverComprobantes.cs (C#) y driver_prueba_comprobantes_v2.dart.
// Compilado a JS source via compilar.ts y publicado en data.ts_cliente_driver.
//
...
export default class DriverV1 implements ComprobanteDriver {
  readonly version = 'v1';
...
function rncValido(rnc: string): boolean {
